            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="info_group">
                        <label>入住时间</label><input type="test" name="arriveDate" id="arriveDate" class="datepicker"/>
						<label>离店时间</label><input type="test" name="leaveDate" id="leaveDate" class="datepicker"/>
                    </div>
                ...
                <li>
                    ...
                    <div class="info_group">
                        <label>电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话</label><input type="text" name="phoneNum" id="phoneNum" value="${account.phoneNum}" /><span class="msg"></span>
                    </div>
					<div class="info_group">
                ...
                <li>
                    <div class="msg">
                        预定须知:请携带好本人的身份证，办理入住手续，本店办理入住需要在前台缴费押金 ￥200

                    </div>
                    <input type="hidden" name="uname" value="0">
                    <input type="hidden" name="roomList" value="0"/>
                    <input type="hidden" name="foodList" value="[]"/>
...
$(function() {
    ...
    $("#btn_booking").click(function(){
    	...
    	$.ajax({
    		...
    		type:'post',
    		dataType:'json',
    		data:{roomTypeId:'${roomType.id }',name:name,phoneNum:phoneNum,idCard:idCard,remark:remark,arriveDate:arriveDate,leaveDate:leaveDate},
