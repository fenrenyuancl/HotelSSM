...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td align="right">菜单URL:</td>
                <td><input type="text" name="url" id="edit-url" class="wu-text easyui-validatebox" /></td>
            </tr>
            <tr>
                <td align="right">菜单图标:</td>
				<td>
	...
	<form id="add-menu-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="url" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写菜单URL'"  /></td>
            </tr>
            <tr>
...
<!-- 选择图标弹窗 -->
<div id="select-icon-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px;height:300px; padding:10px;">
