...
<div id="particles-js">
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input">
					<input style="width:50%;" type="test" id="cpacha" name="cpacha" value="" placeholder="请输入验证码" onfocus="this.placeholder=''" onblur="this.placeholder='请输入验证码'">
					<div class="login-center-input-text">验证码</div>
					<img id="cpacha-img" title="点击切换验证码" style="cuesor:pointer;" src="get_cpacha?vl=4&w=110&h=30&type=loginCpacha" width="110px" heigth="30px" onclick="changeCpacha()">
				</div>
			</div>
