...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>入住人:</label><input id="search-name" class="wu-text" style="width:100px">
...
<!-- 订单选择弹框 -->
<div id="show-order-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:550px;height:400px; padding:10px;">
	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" id="add-phoneNum" name="phoneNum" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请输入手机号'" /></td>
            	<td></td>
            </tr>
            <tr>
	...
	<form id="edit-form" method="post">
        ...
        <table>
           ...
           <tr>
            ...
            <tr>
                <td align="right">手机号码:</td>
                <td><input type="text" id="edit-phoneNum" name="phoneNum" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请输入手机号'" /></td>
            </tr>
            <tr>
                <td align="right">入住日期:</td>
	...
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'roomId',title:'房间',width:100,formatter:function(value,row,index){
				var roomList = $("#search-room").combobox('getData');
				for(var i=0;i<roomList.length;i++){
					if(roomList[i].value == value)return roomList[i].text;
				}
				return value;
			}},
		...
		$('#show-order-dialog').dialog({
            ...
            buttons: [{
                ...
                handler: function(){
                	...
                	$("#edit-phoneNum").val(selectedOrder.phoneNum);
