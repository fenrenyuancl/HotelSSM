...
<head>
  <meta charset="UTF-8">
  <meta name="Keywords" content="疯人愿|酒店管理系统首页">
  <meta name="Description" content="疯人愿|酒店管理系统首页">
  <title>疯人愿|酒店管理系统首页</title>
...
<section>
  <div id="subject">
	<p style="float:right;">
		...
		<c:if test="${account != null}">
			<a href="../home/account/index">${account.username}</a>&nbsp;&nbsp;|&nbsp;&nbsp;
    ...
    <div id="guest_rooms">
     ...
     <c:forEach items="${roomTypeList }" var="roomType">
        <tr>
          ...
          <td>
          	<c:if test="${roomType.status == 0}">
				<input type="button" class="disable" value="房型已满" ></td>
			</c:if>
			<c:if test="${roomType.status == 1}">
				<input type="button" value="预订" onclick="window.location.href='account/book_order?roomTypeId=${roomType.id}'" ></td>
			</c:if>
